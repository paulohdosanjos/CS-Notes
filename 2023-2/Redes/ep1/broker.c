...
pthread_mutex_t mutex_server_data; // Mutex para controlar acesso às informações globais do servidor. Toda thread que acessa a estrutura _server_data obtém o esse mutex antes.
